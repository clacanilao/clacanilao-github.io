...
CREATE TABLE locations(location_id numeric(4) PRIMARY KEY,street_address varchar(40),postal_code VARCHAR(12),city VARCHAR(30),state_province VARCHAR(25),country_id CHAR(2) REFERENCES countries(country_id));
CREATE SEQUENCE locations_seq START WITH 3300 INCREMENT BY 100 MAXVALUE 9900 NO CYCLE;
CREATE TABLE departments(department_id numeric(4) PRIMARY KEY,department_name VARCHAR(30) NOT NULL,manager_id numeric(6),location_id numeric(4) REFERENCES locations(location_id));
CREATE SEQUENCE departments_seq START WITH 280 INCREMENT BY 10 MAXVALUE 9990 NO CYCLE;
CREATE TABLE jobs(job_id VARCHAR(10) PRIMARY KEY,job_title VARCHAR(35) NOT NULL,min_salary numeric(6),max_salary numeric(6));
CREATE TABLE employees(employee_id numeric(6) PRIMARY KEY,first_name VARCHAR(20),last_name VARCHAR(25) NOT NULL,email VARCHAR(25) NOT NULL,phone_number VARCHAR(20),hire_date DATE NOT NULL,job_id VARCHAR(10) REFERENCES jobs(job_id) NOT NULL,salary numeric(8,2),commission_pct numeric(2,2),manager_id numeric(6) REFERENCES employees(employee_id),department_id numeric(4) REFERENCES departments(department_id),CONSTRAINT emp_salary_min CHECK(salary>0),CONSTRAINT emp_email_uk UNIQUE(email));
ALTER TABLE departments ADD CONSTRAINT dept_mgr_fk FOREIGN KEY(manager_id) REFERENCES employees(employee_id);
CREATE SEQUENCE employees_seq START WITH 208 INCREMENT BY 1 NO CYCLE;
CREATE TABLE job_history(employee_id numeric(6) REFERENCES employees(employee_id) NOT NULL,start_date DATE NOT NULL,end_date DATE NOT NULL,job_id VARCHAR(10) REFERENCES jobs(job_id) NOT NULL,department_id numeric(4) REFERENCES departments(department_id),CONSTRAINT jhist_date_interva CHECK(end_date>start_date));

INSERT INTO regions VALUES(1,'Europe');
INSERT INTO regions VALUES(2,'Americas');
INSERT INTO regions VALUES(3,'Asia');
INSERT INTO regions VALUES(4,'Middle East and Africa');
INSERT INTO regions VALUES(5,'Middle Earth');
...
INSERT INTO countries VALUES('AT','Atlantis',NULL);
...
INSERT INTO locations VALUES( 3300,'Via Sant''Anna Città del Vaticano','00120','Vatican City',NULL,NULL);
...
INSERT INTO departments VALUES(230,'IT Help desk',NULL,1700);
...
INSERT INTO jobs VALUES('HR_REP','HumanResources Representative',4000,9000);
...
INSERT INTO employees VALUES(112,'JoseManuel','Urman','JMURMAN','515.124.4469', TO_DATE('07-03-2006','dd-MM-yyyy'),'FI_ACCOUNT',7800,NULL,108,100);
...
INSERT INTO employees VALUES(178,'Taylor','Grant','TGRANT','011.44.1644.429263',TO_DATE('24-05-2007','dd-MM-yyyy'),'SA_REP',7000,.15,149,NULL);
...
INSERT INTO employees VALUES(184,'Nandita','Jean','NJEAN','650.509.1876',TO_DATE('27-01-2004','dd-MM-yyyy'),'SH_CLERK',4200,NULL,121,50);
...
INSERT INTO employees VALUES(207,INITCAP(LOWER(USER)),'Mc'||INITCAP(LOWER(USER))||'son',UPPER(USER),'204.123.4567',TO_DATE('01-09-2019','dd-MM-yyyy'),'IT_PROG',99999,NULL,NULL,90);
